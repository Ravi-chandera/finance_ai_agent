...
# # Set the API key as an environment variable for Google ADK
...
# INITIAL_STATE = {"topic": "Story in gujarati langauge about a guy with great warrior skills"}
...
# async def main():
#     await call_agent_async("Story in gujarati langauge about a guy with great warrior skills")
